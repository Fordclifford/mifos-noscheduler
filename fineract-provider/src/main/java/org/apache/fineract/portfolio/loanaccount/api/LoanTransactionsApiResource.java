...
public class LoanTransactionsApiResource {
	...
	public String retrieveTransactionTemplate(@PathParam("loanId") final Long loanId,
		...
		if (is(commandParam, "repayment")) {
			...
			if (transactionDateParam == null) {
				...
				transactionDate = LocalDate
						.fromDateFields(transactionDateParam.getDate("transactionDate", dateFormat, locale));
			}
	...
	public String retrieveTransaction(@PathParam("loanId") final Long loanId,
		...
		LoanTransactionData transactionData = this.loanReadPlatformService.retrieveLoanTransaction(loanId,
				transactionId);
		final ApiRequestJsonSerializationSettings settings = this.apiRequestParameterHelper
				.process(uriInfo.getQueryParameters());
	...
	@Consumes({ MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_JSON })
	public String adjustLoanTransaction(@PathParam("loanId") final Long loanId,
			@PathParam("transactionId") final Long transactionId, final String apiRequestBodyAsJson) {
